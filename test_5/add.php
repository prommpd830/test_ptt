    ...
    <div class="container-fluid py-5">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="text-uppercase">Tambah Pegawai</h1>
            </div>
        </div>
        <!-- End Header -->
        <div class="container my-5">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-12 shadow p-5">
                    <form id="form-insert-pegawai" action="action_db/insertPegawai.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" id="formPhoto" name="photo" required>
